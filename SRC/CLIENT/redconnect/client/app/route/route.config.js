(function () {
  ...
  angular.module('app.route')
    ...
    .run(['$rootScope', '$state', 'appConfig', 'loginService',
      function($rootScope, $state, appConfig, loginService) {
        ...
        loginService.protectedRoutes(['root.create',
          'root.detail',
          'root.profile',
          'root.search',
  ...
  function RouteConfig(
    ...
    $stateProvider
      ...
      /*.state('root.create', {
        url: '/create?prev',
        templateUrl: 'app/create-profile/create.html',
      ...
      .state('root.profileSettings', {
        url: '/profilesettings',
        templateUrl: 'app/profile-settings/profile-settings.html',
        controller: 'ProfileSettingsCtrl',
        controllerAs: '$ctrl'
      })
      .state('root.updateProfile', {
        url: '/updateprofile',
        templateUrl: 'app/update-profile/update-profile.html',
