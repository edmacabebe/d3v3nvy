...
var icdHost = options.mlHost;
var icdPort = options.mlHttpPort;
...
app.use('/v1', proxy({target: 'http://'+icdHost+':'+icdPort, changeOrigin: true}));
app.use('/api', proxy({target: 'http://'+icdHost+':'+icdPort, changeOrigin: true}));
